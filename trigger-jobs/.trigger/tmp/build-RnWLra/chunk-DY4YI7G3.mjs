...
async function generateJWT(options) {
  const { SignJWT } = await import("./esm-NNNA63G7.mjs");
...
var APIClientManagerAPI = class _APIClientManagerAPI {
  ...
  runWithConfig(config, fn) {
    ...
    registerGlobal(API_NAME8, $config, true);
    return fn().finally(() => {
      registerGlobal(API_NAME8, originalConfig, true);
    });
  }
  setGlobalAPIClientConfiguration(config) {
    return registerGlobal(API_NAME8, config);
  }
  #getConfig() {
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DY4YI7G3.mjs.map
