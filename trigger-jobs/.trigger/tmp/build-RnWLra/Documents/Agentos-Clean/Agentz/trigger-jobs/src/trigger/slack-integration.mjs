    ...
    var WebClient2 = class _WebClient extends methods_1.Methods {
      ...
      makeRequest(url_1, body_1) {
        return __awaiter(this, arguments, void 0, function* (url, body, headers = {}) {
          const task2 = () => this.requestQueue.add(() => __awaiter(this, void 0, void 0, function* () {
            try {
          ...
          return (0, p_retry_1.default)(task2, this.retryConfig);
        });
      }
      /**
...
// src/trigger/slack-integration.ts
init_esm();
var import_web_api = __toESM(require_dist4());
var sendSlackMessage = task({
  id: "agent-os-slack-message",
  run: async (payload) => {
    const slack = new import_web_api.WebClient(process.env.SLACK_BOT_TOKEN);
    const formattedMessage = payload.agent_name ? `🤖 *${payload.agent_name}* from Agent OS:

${payload.message}` : `🤖 *Agent OS*:
        ...
        blocks: [
          ...
          },
          {
            ...
            elements: [
              {
                type: "mrkdwn",
                text: `Sent by Agent OS • ${(/* @__PURE__ */ new Date()).toLocaleString()}`
              }
            ]
          }
        ]
...
var getSlackWorkspaceInfo = task({
...
var demoAgentOSSlackIntegration = task({
        ...
        blocks: [
          ...
          },
          {
            ...
            elements: [
              {
                type: "mrkdwn",
                text: `Connected via Agent OS • ${(/* @__PURE__ */ new Date()).toLocaleString()}`
              }
            ]
          }
        ]
...
*/
//# sourceMappingURL=slack-integration.mjs.map
